                        ...
                        <TabContentWrapper alignItems="flex-start">
                            ...
                            <Typography.Text>
                                <ul>
                                    ...
                                    <li>
                                        추가설명: 광고성 화장품 순위가 아닌 실제
                                        유저들의 데이터에 기반한 화장품 순위
                                        추천 서비스를 만들었습니다. 아무
                                        화장품이나 바코드를 인식하면 어떤
                                        제품인지 인식할 수 있는 기능을 만들어서
                                        수많은 화장품 정보를 직접 입력해야 하는
                                        수고로움을 덜었씁니다. 사용자의 재구매율
                                        지표를 활용해 사실에 기반한 순위를
                                        추천하도록 하였습니다.
                                    </li>
                                </ul>
                            ...
                            <Typography.Text>
                                <ul>
                                    ...
                                    <li>
                                        추가설명: 국민대학교까지 택시 카풀
                                        파티를 만들 수 있는 서비스를
                                        개발하였습니다. 실제 국민대학교 재학생
                                        선배님들의 의견과 카풀 앱의 단점을
                                        보완하여 정확한 신원과 서비스의 신뢰도를
                                        높여 학우들에게 좋은 반응을 이끌어낼 수
                                        있었습니다. 해커톤 종료 후 실제 서비스로
                                        발전시키려 했으나, 서비스화까지 진행하지
                                        못해 아쉬움이 남는 프로젝트 입니다.
                                    </li>
                                </ul>
                            </Typography.Text>
                            ...
                            <Typography.Text>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        해커톤이었습니다. 카카오에서 서버
                                        개발자로 일하시던 분이 프로젝트를
                                        리드하셨는데 현업에 종사하시는 분들과
                                        팀을 이뤄 진행한 첫 해커톤이어서
                                        프로젝트 완성도가 상당히 높았습니다.
                                        아쉽게도 다른 팀들에 밀려 수상은 하지
                                        못하였지만 무박 3일간 노력하며 과정에
                                        대한 만족도가 제일 높은 해커톤중에
                                        하나였습니다. OCR을 이용해 영수증을
                                        촬영하면 자동으로 사용 내역을 입력해주는
                                        앱을 만들었습니다.
                                    </li>
                                </ul>
                            </Typography.Text>
                        ...
                        <TabContentWrapper alignItems="flex-start">
                            ...
                            <Typography.Text>
                                <ul>
                                    ...
                                    <li>
                                        추가설명: 국민대학교에서 진행한 해외
                                        봉사활동에 참여할 수 있는 소중한 기회를
                                        얻게 되어, 소프트웨어 교육과 노력봉사를
                                        진행하였습니다. 의사소통이 원활하지
                                        않아, 현지 선생님들과 어떻게 하면
                                        효과적으로 수업 내용을 전달할 수
                                        있을지에 대해 깊은 고민을 하며 수업
                                        커리큘럼을 구성할 수 있었던 소중한
                                        시간이었습니다.
                                    </li>
                                </ul>
            ...
            <InfoWrapper flexDirection="column" alignItems="flex-start">
                ...
                <Typography.Text>
                    <ul>
                        ...
                        <li>
                            Developed user feedback component SDK based on React
                        </li>
                    </ul>
                </Typography.Text>
                ...
                <Typography.Text>
                    <ul>
                        <li>
                            Developed user feedback collect system using GraphQL
                        </li>
                    </ul>
                </Typography.Text>
                <br />
                ...
                <Typography.Text>
                    <ul>
                        <li>
                            Developed WebOS signage player app (Installed at
                            투썸플레이스)
                            <ul>
                                <li>
                                    image / video / web template content player
                                </li>
                                <li>
                                    scheduled content playback using cron
                                    expression
                                </li>
                                <li>
                                    multi display synchronized content playback
                                    using control server and WebSocket
                                </li>
                        ...
                        <li>
                            Developed 뚜레쥬르 빵알림 backoffice using Vue.js
                        </li>
                        <li>
                            Developed 뚜레쥬르 Menuboard Coffee & Beverage menu
                            template using Vue.js
                        </li>
                        <li>Developed 뚜레쥬르 빵알림 template using Vue.js</li>
                        <li>
                            Developed VSS AUTO reservation web using Backbone.js
                        </li>
                    </ul>
                </Typography.Text>
                <Typography.Text>on Backend</Typography.Text>
                <Typography.Text>
                    <ul>
                        <li>
                            Developed VSS AUTO reservation backend using Flask
                        </li>
                    </ul>
                </Typography.Text>
...
const Main = () => {
    ...
    React.useEffect(() => {
        const setTopWindow = (key: string) => {
            ...
            const newWindows = [
                ...windowState.windows.filter((w) => w !== key),
                key,
            ];
            setWindowState({
                ...windowState,
